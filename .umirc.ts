...
const umiConfig = {
  ...
  favicon: 'https://avatars.githubusercontent.com/u/21035479?v=4',
  logo: 'https://avatars.githubusercontent.com/u/21035479?v=4',
  outputPath: 'site',
  mode: 'site',
  publicPath,
  alias: {
  ...
  navs: [
    ...
    {
      title: 'GitHub',
      path: 'https://github.com/flyeagleyuan/blog',
    },
  ],
  menus: {
    /***************** nav: 基础 *******************/
